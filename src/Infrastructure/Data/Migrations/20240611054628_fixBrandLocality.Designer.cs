...
namespace Microsoft.eShopWeb.Infrastructure.Data.Migrations
{
    ...
    [Migration("20240611054628_fixBrandLocality")]
    partial class fixBrandLocality
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Entities.CatalogLocality", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CatalogLocalities");
                });

            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Entities.CatalogLocalityItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CatalogLocalityId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CatalogLocalityId");

                    b.ToTable("GetCatalogLocalityItems");
                });
            ...
            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Entities.CatalogLocalityItem", b =>
                {
                    b.HasOne("Microsoft.eShopWeb.ApplicationCore.Entities.CatalogItem", "CatalogItem")
                        .WithMany("CatalogLocalityItems")
                        .HasForeignKey("CatalogItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Microsoft.eShopWeb.ApplicationCore.Entities.CatalogLocality", "CatalogLocality")
                        .WithMany("CatalogLocalityItems")
                        .HasForeignKey("CatalogLocalityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CatalogItem");

                    b.Navigation("CatalogLocality");
                });
            ...
            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Entities.CatalogItem", b =>
                {
                    b.Navigation("CatalogLocalityItems");
                });
